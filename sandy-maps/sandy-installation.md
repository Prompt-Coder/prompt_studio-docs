...
| [Sandy City Hall](sandy-city-hall.md) | `prompt_sandy_cityhall` | [Portal](https://portal.cfx.re/assets/granted-assets?page=1\&sort=asset.updated_at\&direction=asc\&search=Prompt%27s+-+Sandy+City+hall) | `ox_lib` | ✓ |
